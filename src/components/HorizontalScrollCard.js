  ...
  return (
    ...
    <div className='container mx-auto px-3 my-10'>
        ...
        <div className='relative'>
          <div ref={containerRef} className='grid grid-cols-[repeat(auto-fit,240px)] grid-flow-col gap-4 overflow-hidden overflow-x-scroll relative z-10 scroll-smooth transition-all scrollbar-none'>
            {
              data.map((data,index)=>{
                return (
